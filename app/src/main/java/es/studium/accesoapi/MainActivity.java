...
// Aceptar
            ...
            if (txtNombre.equals("") || txtApellidos.equals("") || txtTelefono.equals(""))
            {
    ...
    private class ConsultaRemota extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... argumentos) {
            try {
                ...
                URL url = new URL("http://192.168.0.218/ApiRest/contactos.php");
...
// Actualizamos los cuadros de texto
    ...
    private class BajaRemota extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
// Crear la URL de conexión al API
                URI baseUri = new URI("http://192.168.0.218/ApiRest/contactos.php");
